  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center">
            <div className="lg:w-1/2 lg:pr-12 mb-10 lg:mb-0">
              <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-6" style={{ fontFamily: "'Merriweather', serif" }}>
                {APP_TAGLINE}
              </h1>
              <p className="text-lg md:text-xl opacity-90 mb-8 max-w-2xl">
                Your one-stop platform for self-publishing, editing, and distributing your e-books to readers worldwide.
              </p>
            ...
            <div className="lg:w-1/2 relative">
              <div className="relative rounded-lg overflow-hidden shadow-2xl">
                ...
                <div className="absolute bottom-0 left-0 p-6">
                  <p className="text-white text-sm font-medium mb-2">FEATURED AUTHOR</p>
                  <p className="text-white text-xl font-bold" style={{ fontFamily: "'Playfair Display', serif" }}>
                    "PageCraft helped me bring my story to life."
                  </p>
                </div>
              </div>
      ...
      <section id="services" className="py-16 bg-neutral-100">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4" style={{ fontFamily: "'Merriweather', serif" }}>How It Works</h2>
            <p className="text-lg text-neutral-800 max-w-3xl mx-auto">
              Our simple 4-step process to take your manuscript from draft to published e-book
            </p>
          </div>
      ...
      <section id="bookstore" className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-12">
            <div>
              <h2 className="text-3xl font-bold mb-2" style={{ fontFamily: "'Merriweather', serif" }}>Featured Books</h2>
      ...
      <section className="py-16 bg-neutral-100">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4" style={{ fontFamily: "'Merriweather', serif" }}>Author Spotlight</h2>
            <p className="text-lg text-neutral-800 max-w-3xl mx-auto">
              Meet the successful authors who chose {APP_NAME} for their publishing journey
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="p-8 md:p-12">
                <p className="text-[#E94F37] font-medium mb-4">FEATURED AUTHOR</p>
                <h3 className="text-2xl font-bold mb-4" style={{ fontFamily: "'Merriweather', serif" }}>{FEATURED_AUTHOR.name}</h3>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <Button variant="outline" className="px-4 py-2 border border-primary text-primary rounded-md font-medium hover:bg-primary hover:text-white transition-colors">
                    View Books
                  </Button>
                </div>
              </div>
      ...
      <section id="testimonials" className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4" style={{ fontFamily: "'Merriweather', serif" }}>What Our Authors Say</h2>
            <p className="text-lg text-neutral-800 max-w-3xl mx-auto">
      ...
      <section className="py-16 bg-primary">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-4 text-white" style={{ fontFamily: "'Merriweather', serif" }}>Subscribe to Our Newsletter</h2>
            <p className="text-lg text-white/90 mb-8">
              Get the latest publishing tips, author success stories, and exclusive offers delivered to your inbox.
            </p>
